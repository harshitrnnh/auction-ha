...
const collectDailyData = async (date) => {
    ...
    // 6. Apple Music Top Songs (US storefront, updated daily)
...
- The layout structure of the poster is as follows:
  ...
  6. NO TEXT INSIDE CENTRAL ARTWORK: There must be absolutely NO text, letters, words, labels, song names, artist names, or textual references of any kind drawn, printed, or rendered inside the central surrealist artwork graphic itself. The central graphic must be purely visual.
