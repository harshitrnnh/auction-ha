...
async function runSandboxTest6() {
  console.log('--- STARTING EXQUISITE CORPSE SURREALIST ARTWORK TEST 6 ---');
...
========================================
COMPOSITION & ARTWORK ARCHITECTURE (THE EXQUISITE CORPSE)
=========================================================

- The central illustration must be structured as a classic Surrealist "Exquisite Corpse" (cadavre exquis) hybrid figure or object.
- The artwork consists ONLY of a single clean, striking, composite hybrid graphic centered on a plain background. 
- Absolutely NO borders, NO framing lines, NO visual icons, NO headers, NO footers, and absolutely NO text/letters/words anywhere on the image.
- The hybrid entity must occupy roughly 80% of the composition.
- The structure of the graphic must be divided into three vertically stacked, seamlessly connected sections (Head/Top, Torso/Middle, Legs/Base/Bottom):
  - Each of the three sections must represent a completely different aspect of the day's collected data signals, featuring weird combinations, unexpected juxtapositions, and dream-like mutations.
  - The sections must connect physically to form a single, bizarre composite entity (e.g., creature, machine, or monument).
  - For example, the top section could be a celestial body, a sound wave shape, or a telescope; the middle section could be a segmented shell resembling self-healing concrete or cave art; the bottom section could be a cluster of wheels or a bubble floating on waves.
- Dial up the surrealism: focus on impossible joins, bizarre anatomical mutations, and a logic of dreams, while ensuring relevance to the day's signals.
...
- Vector illustration aesthetic, clean background, crisp edges, high contrast, strong silhouette, graphic clarity, clean negative space.
...

{
  ...
  "subtitle": "",
  "micro_caption": "",
  "image_prompt": "Highly detailed prompt to generate the FRONT artwork containing ONLY the central composite hybrid entity (structured as a Surrealist Exquisite Corpse with three vertically stacked and connected sections based on different signals) on a plain warm off-white background. Absolutely NO borders, NO icons, NO headers/footers, and absolutely NO text/letters/words anywhere on the image.",
