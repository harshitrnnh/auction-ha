...
- The layout structure of the poster is as follows:
  1. TOP HEADER: Centered at the top, print the exact text "Field Notes From the Day" in a clean, elegant, white sans-serif font.
  2. TOP SUBHEADER: Centered directly below the top header, print the exact text "[Resolved Date String]   •   EDITION NO. [Resolved Edition Number]" in a smaller, clean, white sans-serif font.
  3. CENTRAL ARTWORK: A large, centered, highly surrealist and dream-like graphic, drawn in white and light-silver line art, occupying roughly 70% of the composition.
     - **SUBSET INCLUSION**: Do NOT attempt to force all 6 daily signals into the artwork. Instead, select a subset of 3-4 signals that are the most visually compatible and interesting to blend together into a cohesive entity.
     ...
     - **SEAMLESS MORPHING**: All selected elements must physically morph, dissolve, and flow out of one another as a single continuous form. Avoid placing separate elements on top of or next to each other (e.g. do NOT draw a puppy sitting next to a nest, or a crown worn as a separate bracelet). Instead, the elements must be sculpted from the same continuous material and form: the fingers of a concrete hand morph directly into the twigs of a bird's nest, the puppy's face or body emerges directly from the thumb or forearm as a sculpted relief, the wrist is carved into the likeness of the Siamese crown, and the black hole's gravity waves warp and distort the entire hand-nest structure into a single swirling, fluid shape. Every signal must be fully fused and indistinguishable from the main central entity.
  4. BOTTOM TITLE: Centered below the central graphic, print the exact title "[Title]" (strictly 3-4 words maximum) in the same clean, elegant, white sans-serif font and size as the top header "Field Notes From the Day" text.
...
- Monochrome only: white/light-silver ink/graphic and text on plain solid black background (designed to be printed on a black t-shirt).
...
{
  "date": "YYYY-MM-DD",
  "data_signals_used": ["A list of 6 daily signals used. For each signal, write a very short summary (2-3 words maximum, e.g. 'OpenAI Public', 'Interest Rates Drop', 'World Top Song')."],
  "condensed_signals_line1": "The first 3 daily signals formatted exactly as: 'Signal 1  •  Signal 2  •  Signal 3'",
  "condensed_signals_line2": "The remaining 3 daily signals formatted exactly as: 'Signal 4  •  Signal 5  •  Signal 6'",
  "essence": "Describe the core visual amalgamation in a sentence, including which signals were chosen and how they combine.",
  "title": "A striking title (exactly 3-4 words maximum).",
  "subtitle": "",
  "micro_caption": "",
  "image_prompt": "Highly detailed prompt to generate the complete poster (artwork with text labels rendered directly inside the image in a vertical 3:4 ratio). The prompt must explicitly describe the solid black background and detail the exact text overlays using quotation marks: 1. Top text: 'Field Notes From the Day'. 2. Subheader: '[Resolved Date String]   •   EDITION NO. [Resolved Edition Number]'. 3. In the center, a single, large, highly integrated surrealist central graphic (select a subset of 3-4 most visually compatible daily signals and describe how they seamlessly morph and fuse into ONE single continuous composite entity, flowing out of one another, with absolutely NO separate elements placed next to each other, and absolutely NO borders, NO frames, or NO framing lines around the graphic or the poster). 4. Bottom title: '[Title]' (exactly 3-4 words) in the same clean, elegant, white sans-serif font and size as the top header 'Field Notes From the Day' text. Absolutely NO other text is to be rendered at the bottom of the poster (specifically, do NOT print the daily signals or micro-caption at the bottom of the image). The entire background of the image—specifically including the areas behind the text parts—must be a uniform, continuous, solid pitch-black background, with absolutely no boxes, banners, cards, panels, or borders behind or around the text. All text and graphics must be rendered in clean sans-serif typography, in monochrome white/light-silver directly on a solid black background.",
