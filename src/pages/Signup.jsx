...
export default function Signup() {
  ...
  // Step state: 'enter_email' | 'enter_otp' | 'profile_setup'
  ...
  const handleGoogleSuccess = async (credential) => {
    ...
    try {
      ...
      if (data.isNew) {
        ...
        // If they already have an account, log them in directly
      ...
      <div className="auth-card" style={{ maxWidth: '420px' }}>
        ...
        {step === 'enter_email' && (
          <div>
            ...
            <p className="auth-sub">Register to bid on exclusive items. Verify your email to get started.</p>
            ...
            <div className="auth-form">
              ...
              <div style={{ display: 'flex', alignItems: 'center', margin: '8px 0 16px' }}>
                ...
                <span style={{ fontSize: '11px', color: 'var(--txt-mute)', textTransform: 'uppercase', letterSpacing: '0.12em', padding: '0 12px' }}>or register with email</span>
                <div style={{ flex: 1, height: '1px', background: 'var(--line)' }} />
              </div>
              ...
              <div className="auth-field">
                ...
                <input
                  ...
                  onKeyDown={(e) => e.key === 'Enter' && isEmailValid && requestOtp()}
                  disabled={loading}
                />
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '12px' }}>
                ...
                {resendTimer > 0 ? (
                  ...
                  <button 
                    className="link-btn" 
                    onClick={() => {
                      sendEmailOtp(email, 'signup').catch(() => {});
                      setResendTimer(60);
                      setOtpValues(['', '', '', '', '', '']);
                      otpRefs[0].current?.focus();
                    }}
